...
["", "main.dart", , F, {
  ...
  main: [function() {
    ...
    t3 = window;
    t4 = D.RouteImpl$_new(false, null, null, null);
    ...
    t4.addRoute$3$enter$name$path(F.showBackground$closure(), "background", "/background");
    t4.addRoute$4$defaultRoute$enter$name$path(true, F.showHome$closure(), "home", "/");
    router.listen$0();
  }, "call$0", "main$closure", 0, 0, 3],
  showBackground: [function(e) {
    J.set$display$x(document.querySelector("#home").style, "none");
    J.set$display$x(document.querySelector("#background").style, "");
  }, "call$1", "showBackground$closure", 2, 0, 12],
  showHome: [function(e) {
    J.set$display$x(document.querySelector("#home").style, "");
    J.set$display$x(document.querySelector("#background").style, "none");
  }, "call$1", "showHome$closure", 2, 0, 12]
},
1],
["nav_menu", "package:presentation/nav_menu.dart", , L, {
  "^": "",
...
["route.client", "package:route_hierarchical/client.dart", , D, {
  ...
  RouteImpl: {
    ...
    addRoute$3$enter$name$path: function(enter, name, path) {
      return this.addRoute$9$defaultRoute$dontLeaveOnParamChanges$enter$leave$mount$name$path$preEnter$preLeave(false, false, enter, null, null, name, path, null, null);
    },
    addRoute$4$defaultRoute$enter$name$path: function(defaultRoute, enter, name, path) {
      return this.addRoute$9$defaultRoute$dontLeaveOnParamChanges$enter$leave$mount$name$path$preEnter$preLeave(defaultRoute, false, enter, null, null, name, path, null, null);
    },
  ...
  Router: {
    ...
    }, "route$1", "call$2$startingFrom", "call$1", "get$route", 2, 3, 30, 6],
      ...
      for (ll = P.min(trimmedActivePath.length, treePath.length), leaveBase = baseRoute, mustLeave = trimmedActivePath, i = 0; i < ll; ++i) {
        ...
        if (J.$eq(t2, treePath[i].route)) {
          ...
          if (!treePath[i].route.get$dontLeaveOnParamChanges()) {
            ...
            t2 = !(lastEvent == null || !J.$eq(lastEvent.path, t3.get$match()) || !U.mapsShallowEqual(lastEvent.parameters, t3.parameters));
          } else
            t2 = true;
        } else
          t2 = false;
    ...
    _parseQuery$2: function(route, path) {
      ...
      if (t1.indexOf$1(path, "?") === -1)
        return params;
      C.JSArray_methods.forEach$1(t1.substring$1(path, t1.indexOf$1(path, "?") + 1).split("&"), new D.Router__parseQuery_closure(this, route, params));
      return params;
    },
  ...
  Router__preLeave_closure0: {
    "^": "Closure:31;box_0,this_2,path_3,treePath_4,leaveBase_5,activePath_6,baseRoute_7",
  ...
  Router__preLeave__closure0: {
    "^": "Closure:13;box_0,this_8,leaveBase_9",
    call$0: function() {
  ...
  Router__preEnter_closure: {
    ...
    call$1: function(matchedRoute) {
      ...
      t5 = t4.get$_onPreEnterController();
      if (t5._state >= 4)
  ...
  Router__preEnter_closure0: {
    "^": "Closure:31;box_0,this_2,leaveFn_3",
    call$1: function(results) {
      var t1;
  ...
  Router__enter_closure: {
    ...
    call$1: function(matchedRoute) {
      ...
      $event = new D.RouteEnterEvent(t1, t2, t3);
      t2 = this.box_0;
      t2.base_0.set$_currentRoute(t3);
      t2.base_0.get$_currentRoute().set$_lastEvent($event);
      t1 = t3.get$_onEnterController();
      if (t1._state >= 4)
        H.throwExpression(t1._addEventError$0());
  ...
  Router__parseQuery_closure: {
    "^": "Closure:17;this_0,route_1,params_2",
